...
export class DocController {
    ...
    @Post('create')
    async createDoc(@Body() createDocDTO: CreateDocDTO, @Res() res: Response, @CurrentUser('userId') userId ){
        try {
    ...
    @Get(':id/:actFlg')
    async findAllDocsBySpcId(@Param('id') id: string, @Param('actFlg') actFlg: boolean, @Res() res: Response) {
        try {
    ...
    async deleteDoc (@Param('id') id: string, @Res() res: Response, @CurrentUser('userId') userId){
        try {
